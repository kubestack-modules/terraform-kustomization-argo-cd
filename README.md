...
This module installs Argo-cd on Kubernetes.
...
The module bundles an upstream release of Argo-cd and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/argo-cd/kustomization"
